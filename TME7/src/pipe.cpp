...
//    std::vector<const char*> commande1(argv + 1, argv + p);
...
//        }
//        close(fd[0]);   //read
//        execv(commande2[0], const_cast<char* const*>(commande2.data()));
...
//        }
//        close(fd[1]);
//        execv(commande1[0], const_cast<char* const*>(commande1.data()));
